...
const messages = [
    "Gửi đến người phụ nữ tuyệt vời nhất trong cuộc đời tớ, Pumm mang đến niềm vui và hạnh phúc cho mỗi ngày.",
    "Nụ cười của cậu thắp sáng thế giới của tớ, và tình yêu của pumm lấp đầy trái tim tớ bằng sự ấm áp.",
    "Vào ngày đặc biệt này, tớ muốn Pumm biết cậu có ý nghĩa như thế nào đối với tớ.",
    "Cậu không chỉ là crush của tớ, Pumm là bạn thân nhất của tớ, là người bạn tâm giao và là tất cả của tớ.",
